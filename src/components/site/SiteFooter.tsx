      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
        <div className="md:col-span-1">
          ...
          <p className="mt-4 text-sm text-primary-foreground/80">
            Hyper-local home services with a fair bidding model. Free for customers, with a simple platform fee for providers — no subscriptions.
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-primary-foreground/80">
            ...
            <li className="flex items-start gap-2.5">
              ...
              <a href="mailto:cqlsysvishal@gmail.com" className="break-all hover:text-accent">cqlsysvishal@gmail.com</a>
            </li>
            <li className="flex items-start gap-2.5">
